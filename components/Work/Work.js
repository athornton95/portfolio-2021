...
const Block = (props) => {
  ...
  return (
  <div className='flex sm:items-center' id='work' ref={forwardedRef}>
    <div>
      <span className='text-textPrimary text-xl font-title'>03.</span><p className='text-textSecondary text-3xl font-display font-semibold pl-2 inline section-header relative w-full'>Some Things I've Built</p>
    </div>
  </div>
  );
};
